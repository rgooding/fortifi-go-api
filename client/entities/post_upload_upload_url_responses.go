...
// Code gets the status code for the post upload upload Url o k response
func (o *PostUploadUploadURLOK) Code() int {
	return 200
}
...
// ContextValidate validate this post upload upload URL o k body based on the context it is used
func (o *PostUploadUploadURLOKBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *PostUploadUploadURLOKBody) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
