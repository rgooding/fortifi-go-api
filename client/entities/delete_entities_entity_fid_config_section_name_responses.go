...
// Code gets the status code for the delete entities entity fid config section name o k response
func (o *DeleteEntitiesEntityFidConfigSectionNameOK) Code() int {
	return 200
}
