...
// Code gets the status code for the put entities entity fid properties values property name o k response
func (o *PutEntitiesEntityFidPropertiesValuesPropertyNameOK) Code() int {
	return 200
}
