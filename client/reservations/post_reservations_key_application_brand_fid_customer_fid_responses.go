...
// PostReservationsKeyApplicationBrandFidCustomerFidReader is a Reader for the PostReservationsKeyApplicationBrandFidCustomerFid structure.
type PostReservationsKeyApplicationBrandFidCustomerFidReader struct {
	formats strfmt.Registry
}

// ReadResponse reads a server response into the received o.
func (o *PostReservationsKeyApplicationBrandFidCustomerFidReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	switch response.Code() {
	case 200:
		result := NewPostReservationsKeyApplicationBrandFidCustomerFidOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	default:
		result := NewPostReservationsKeyApplicationBrandFidCustomerFidDefault(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
// NewPostReservationsKeyApplicationBrandFidCustomerFidOK creates a PostReservationsKeyApplicationBrandFidCustomerFidOK with default headers values
func NewPostReservationsKeyApplicationBrandFidCustomerFidOK() *PostReservationsKeyApplicationBrandFidCustomerFidOK {
...
Pixels
*/
type PostReservationsKeyApplicationBrandFidCustomerFidOK struct {
...
func (o *PostReservationsKeyApplicationBrandFidCustomerFidOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(PostReservationsKeyApplicationBrandFidCustomerFidOKBody)
...
// NewPostReservationsKeyApplicationBrandFidCustomerFidDefault creates a PostReservationsKeyApplicationBrandFidCustomerFidDefault with default headers values
func NewPostReservationsKeyApplicationBrandFidCustomerFidDefault(code int) *PostReservationsKeyApplicationBrandFidCustomerFidDefault {
	return &PostReservationsKeyApplicationBrandFidCustomerFidDefault{
		_statusCode: code,
	}
}
...
Error
*/
type PostReservationsKeyApplicationBrandFidCustomerFidDefault struct {
	_statusCode int
...
func (o *PostReservationsKeyApplicationBrandFidCustomerFidDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
type PostReservationsKeyApplicationBrandFidCustomerFidOKBody struct {
	...
	// data
	Data *models.Reservation `json:"data,omitempty"`
}

// UnmarshalJSON unmarshals this object from a JSON structure
func (o *PostReservationsKeyApplicationBrandFidCustomerFidOKBody) UnmarshalJSON(raw []byte) error {
	// PostReservationsKeyApplicationBrandFidCustomerFidOKBodyAO0
	var postReservationsKeyApplicationBrandFidCustomerFidOKBodyAO0 models.Envelope
	if err := swag.ReadJSON(raw, &postReservationsKeyApplicationBrandFidCustomerFidOKBodyAO0); err != nil {
		return err
	}
	o.Envelope = postReservationsKeyApplicationBrandFidCustomerFidOKBodyAO0

	// PostReservationsKeyApplicationBrandFidCustomerFidOKBodyAO1
	var dataPostReservationsKeyApplicationBrandFidCustomerFidOKBodyAO1 struct {
		Data *models.Reservation `json:"data,omitempty"`
	}
	if err := swag.ReadJSON(raw, &dataPostReservationsKeyApplicationBrandFidCustomerFidOKBodyAO1); err != nil {
		return err
	}

	o.Data = dataPostReservationsKeyApplicationBrandFidCustomerFidOKBodyAO1.Data

	return nil
}

// MarshalJSON marshals this object to a JSON structure
func (o PostReservationsKeyApplicationBrandFidCustomerFidOKBody) MarshalJSON() ([]byte, error) {
	_parts := make([][]byte, 0, 2)

	postReservationsKeyApplicationBrandFidCustomerFidOKBodyAO0, err := swag.WriteJSON(o.Envelope)
	if err != nil {
		return nil, err
	}
	_parts = append(_parts, postReservationsKeyApplicationBrandFidCustomerFidOKBodyAO0)
	var dataPostReservationsKeyApplicationBrandFidCustomerFidOKBodyAO1 struct {
		Data *models.Reservation `json:"data,omitempty"`
	}

	dataPostReservationsKeyApplicationBrandFidCustomerFidOKBodyAO1.Data = o.Data

	jsonDataPostReservationsKeyApplicationBrandFidCustomerFidOKBodyAO1, errPostReservationsKeyApplicationBrandFidCustomerFidOKBodyAO1 := swag.WriteJSON(dataPostReservationsKeyApplicationBrandFidCustomerFidOKBodyAO1)
	if errPostReservationsKeyApplicationBrandFidCustomerFidOKBodyAO1 != nil {
		return nil, errPostReservationsKeyApplicationBrandFidCustomerFidOKBodyAO1
	}
	_parts = append(_parts, jsonDataPostReservationsKeyApplicationBrandFidCustomerFidOKBodyAO1)
	return swag.ConcatJSON(_parts...), nil
}

// Validate validates this post reservations key application brand fid customer fid o k body
func (o *PostReservationsKeyApplicationBrandFidCustomerFidOKBody) Validate(formats strfmt.Registry) error {
	var res []error
...
func (o *PostReservationsKeyApplicationBrandFidCustomerFidOKBody) validateData(formats strfmt.Registry) error {
...
// ContextValidate validate this post reservations key application brand fid customer fid o k body based on the context it is used
func (o *PostReservationsKeyApplicationBrandFidCustomerFidOKBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *PostReservationsKeyApplicationBrandFidCustomerFidOKBody) MarshalBinary() ([]byte, error) {
	if o == nil {
		return nil, nil
	}
...
func (o *PostReservationsKeyApplicationBrandFidCustomerFidOKBody) UnmarshalBinary(b []byte) error {
	var res PostReservationsKeyApplicationBrandFidCustomerFidOKBody
