...
// Code gets the status code for the put orders order fid products order product fid quantity o k response
func (o *PutOrdersOrderFidProductsOrderProductFidQuantityOK) Code() int {
	return 200
}
