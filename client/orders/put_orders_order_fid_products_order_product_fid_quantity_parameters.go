...
/* PutOrdersOrderFidProductsOrderProductFidQuantityParams contains all the parameters to send to the API endpoint
   for the put orders order fid products order product fid quantity operation.
...
// WithDefaults hydrates default values in the put orders order fid products order product fid quantity params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PutOrdersOrderFidProductsOrderProductFidQuantityParams) WithDefaults() *PutOrdersOrderFidProductsOrderProductFidQuantityParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the put orders order fid products order product fid quantity params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PutOrdersOrderFidProductsOrderProductFidQuantityParams) SetDefaults() {
