...
// Code gets the status code for the get publishers publisher fid finance cost import cost import fid o k response
func (o *GetPublishersPublisherFidFinanceCostImportCostImportFidOK) Code() int {
	return 200
}
