...
// Code gets the status code for the get contacts find by reference contact reference o k response
func (o *GetContactsFindByReferenceContactReferenceOK) Code() int {
	return 200
}
