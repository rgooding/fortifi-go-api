...
/*GetContactsFindByReferenceContactReferenceOK handles this case with default header values.
...
/*GetContactsFindByReferenceContactReferenceDefault handles this case with default header values.
