...
/*PostProductsProductFidAvailabilityReserveOK handles this case with default header values.
...
/*PostProductsProductFidAvailabilityReserveDefault handles this case with default header values.
