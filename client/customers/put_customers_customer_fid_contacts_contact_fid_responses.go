...
// Code gets the status code for the put customers customer fid contacts contact fid o k response
func (o *PutCustomersCustomerFidContactsContactFidOK) Code() int {
	return 200
}
