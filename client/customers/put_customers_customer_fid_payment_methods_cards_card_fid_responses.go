...
// Code gets the status code for the put customers customer fid payment methods cards card fid o k response
func (o *PutCustomersCustomerFidPaymentMethodsCardsCardFidOK) Code() int {
	return 200
}
