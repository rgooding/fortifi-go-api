...
PutCustomersCustomerFidQualifiedParams contains all the parameters to send to the API endpoint
	...
	for the put customers customer fid qualified operation.
...
// WithDefaults hydrates default values in the put customers customer fid qualified params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PutCustomersCustomerFidQualifiedParams) WithDefaults() *PutCustomersCustomerFidQualifiedParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the put customers customer fid qualified params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *PutCustomersCustomerFidQualifiedParams) SetDefaults() {
