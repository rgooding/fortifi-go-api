...
// Code gets the status code for the put customers customer fid subscriptions subscription fid set parent subscription o k response
func (o *PutCustomersCustomerFidSubscriptionsSubscriptionFidSetParentSubscriptionOK) Code() int {
	return 200
}
