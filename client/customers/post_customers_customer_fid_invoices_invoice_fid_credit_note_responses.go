...
// Code gets the status code for the post customers customer fid invoices invoice fid credit note o k response
func (o *PostCustomersCustomerFidInvoicesInvoiceFidCreditNoteOK) Code() int {
	return 200
}
