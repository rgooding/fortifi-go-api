...
// Code gets the status code for the put customers customer fid external reference o k response
func (o *PutCustomersCustomerFidExternalReferenceOK) Code() int {
	return 200
}
