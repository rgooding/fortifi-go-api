...
// Code gets the status code for the get customers customer fid invoices invoice fid download o k response
func (o *GetCustomersCustomerFidInvoicesInvoiceFidDownloadOK) Code() int {
	return 200
}
