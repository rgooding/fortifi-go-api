...
// Code gets the status code for the get customers customer fid tickets ticket fid posts o k response
func (o *GetCustomersCustomerFidTicketsTicketFidPostsOK) Code() int {
	return 200
}
