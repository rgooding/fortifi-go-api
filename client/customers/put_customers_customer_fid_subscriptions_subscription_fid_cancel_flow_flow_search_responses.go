...
// Code gets the status code for the put customers customer fid subscriptions subscription fid cancel flow flow search o k response
func (o *PutCustomersCustomerFidSubscriptionsSubscriptionFidCancelFlowFlowSearchOK) Code() int {
	return 200
}
