...
/*GetCustomersCustomerFidOrdersOK handles this case with default header values.
...
/*GetCustomersCustomerFidOrdersDefault handles this case with default header values.
