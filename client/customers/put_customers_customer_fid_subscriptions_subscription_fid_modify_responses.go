...
// Code gets the status code for the put customers customer fid subscriptions subscription fid modify o k response
func (o *PutCustomersCustomerFidSubscriptionsSubscriptionFidModifyOK) Code() int {
	return 200
}
...
// ContextValidate validate this put customers customer fid subscriptions subscription fid modify o k body based on the context it is used
func (o *PutCustomersCustomerFidSubscriptionsSubscriptionFidModifyOKBody) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (o *PutCustomersCustomerFidSubscriptionsSubscriptionFidModifyOKBody) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
