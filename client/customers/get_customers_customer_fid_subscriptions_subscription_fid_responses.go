...
// Code gets the status code for the get customers customer fid subscriptions subscription fid o k response
func (o *GetCustomersCustomerFidSubscriptionsSubscriptionFidOK) Code() int {
	return 200
}
