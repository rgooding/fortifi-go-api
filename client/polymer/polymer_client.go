...
// New creates a new polymer API client.
func New(transport runtime.ClientTransport, formats strfmt.Registry) ClientService {
	return &Client{transport: transport, formats: formats}
}

/*
Client for polymer API
*/
type Client struct {
...
type ClientService interface {
	GetPolymersListCodeParentFid(params *GetPolymersListCodeParentFidParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetPolymersListCodeParentFidOK, error)
...
func (a *Client) GetPolymersListCodeParentFid(params *GetPolymersListCodeParentFidParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetPolymersListCodeParentFidOK, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "GetPolymersListCodeParentFid",
		Method:             "GET",
		PathPattern:        "/polymers/list/{code}/{parentFid}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetPolymersListCodeParentFidReader{formats: a.formats},
		AuthInfo:           authInfo,
