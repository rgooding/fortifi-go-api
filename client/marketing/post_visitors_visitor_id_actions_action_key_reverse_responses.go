...
// Code gets the status code for the post visitors visitor Id actions action key reverse o k response
func (o *PostVisitorsVisitorIDActionsActionKeyReverseOK) Code() int {
	return 200
}
