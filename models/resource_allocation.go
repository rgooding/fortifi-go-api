...
// ContextValidate validates this resource allocation based on context it is used
func (m *ResourceAllocation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
