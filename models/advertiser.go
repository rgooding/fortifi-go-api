...
// ContextValidate validate this advertiser based on the context it is used
func (m *Advertiser) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
