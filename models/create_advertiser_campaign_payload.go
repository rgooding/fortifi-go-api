...
// ContextValidate validates this create advertiser campaign payload based on context it is used
func (m *CreateAdvertiserCampaignPayload) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
