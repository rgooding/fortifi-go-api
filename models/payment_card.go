...
// ContextValidate validate this payment card based on the context it is used
func (m *PaymentCard) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
