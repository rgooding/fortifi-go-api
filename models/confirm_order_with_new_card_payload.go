...
// ContextValidate validates this confirm order with new card payload based on context it is used
func (m *ConfirmOrderWithNewCardPayload) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
