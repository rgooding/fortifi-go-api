...
// ContextValidate validate this chat session based on the context it is used
func (m *ChatSession) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
