...
func NewCustomerSubscriptionType(value CustomerSubscriptionType) *CustomerSubscriptionType {
	return &value
}

// Pointer returns a pointer to a freshly-allocated CustomerSubscriptionType.
func (m CustomerSubscriptionType) Pointer() *CustomerSubscriptionType {
	return &m
}
...
func (m CustomerSubscriptionType) validateCustomerSubscriptionTypeEnum(path, location string, value CustomerSubscriptionType) error {
	if err := validate.EnumCase(path, location, value, customerSubscriptionTypeEnum, true); err != nil {
		return err
	}
	return nil
}
...
// ContextValidate validates this customer subscription type based on context it is used
func (m CustomerSubscriptionType) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
