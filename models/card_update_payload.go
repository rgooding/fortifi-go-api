...
// ContextValidate validates this card update payload based on context it is used
func (m *CardUpdatePayload) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
