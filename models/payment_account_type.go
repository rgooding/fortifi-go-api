...
func (m PaymentAccountType) validatePaymentAccountTypeEnum(path, location string, value PaymentAccountType) error {
	if err := validate.EnumCase(path, location, value, paymentAccountTypeEnum, true); err != nil {
		return err
	}
	return nil
}
...
// ContextValidate validates this payment account type based on context it is used
func (m PaymentAccountType) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
