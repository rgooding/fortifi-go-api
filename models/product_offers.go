...
// ContextValidate validate this product offers based on the context it is used
func (m *ProductOffers) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *ProductOffers) contextValidateOffers(ctx context.Context, formats strfmt.Registry) error {
