...
// ContextValidate validates this key value payload based on context it is used
func (m *KeyValuePayload) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
