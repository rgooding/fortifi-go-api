...
// ContextValidate validate this order products based on the context it is used
func (m *OrderProducts) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OrderProducts) contextValidateProducts(ctx context.Context, formats strfmt.Registry) error {
