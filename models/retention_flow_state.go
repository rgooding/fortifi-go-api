...
// RetentionFlowState Retention Flow State
//
// swagger:model RetentionFlowState
type RetentionFlowState struct {
	Entity

	// choices
	Choices []*RetentionFunnelDecision `json:"choices"`
	...
	// step data
	StepData *RetentionFunnelStep `json:"stepData,omitempty"`
...
func (m *RetentionFlowState) UnmarshalJSON(raw []byte) error {
	// AO0
	var aO0 Entity
...
func (m RetentionFlowState) MarshalJSON() ([]byte, error) {
...
// Validate validates this retention flow state
func (m *RetentionFlowState) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RetentionFlowState) validateChoices(formats strfmt.Registry) error {
...
func (m *RetentionFlowState) validateStepData(formats strfmt.Registry) error {
...
// ContextValidate validate this retention flow state based on the context it is used
func (m *RetentionFlowState) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *RetentionFlowState) contextValidateChoices(ctx context.Context, formats strfmt.Registry) error {
...
func (m *RetentionFlowState) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *RetentionFlowState) UnmarshalBinary(b []byte) error {
	var res RetentionFlowState
