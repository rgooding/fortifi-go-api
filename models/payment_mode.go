...
// ContextValidate validates this payment mode based on context it is used
func (m PaymentMode) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
